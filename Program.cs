...
//Console.WriteLine(doubleHash.Get("bbb"));
//Console.WriteLine(doubleHash.Get("gg"));
//doubleHash.List();
...
//Console.WriteLine(quadraticHash.Get("bbb"));
//Console.WriteLine(quadraticHash.Get("gg"));
//quadraticHash.List();
...
//Console.WriteLine(linearHash.Get("bbb"));
